        ...
        ShellMenu.mainMenu(
            ...
            menus: [
                ...
                ShellMenu.submenu("View", [
                    ...
                    ShellMenu.web("Task Sheet", "view.sheet", "5"),
                    ShellMenu.web("Resource Sheet", "view.resources", "6"),
                    ShellMenu.web("Resource Usage", "view.usage", "7"),
                    ShellMenu.web("Network Diagram", "view.network", "8"),
                    .separator(),
