        ...
        ShellMenu.mainMenu(
            ...
            menus: [
                ...
                ShellMenu.submenu("View", [
                    ...
                    ShellMenu.web("Task Sheet", "view.sheet", "4"),
                    ShellMenu.web("Resource Sheet", "view.resources", "5"),
                    ShellMenu.web("Resource Usage", "view.usage", "6"),
                    ShellMenu.web("Network Diagram", "view.network", "7"),
                    .separator(),
